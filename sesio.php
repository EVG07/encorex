...
<head>
  ...
  <script async defer crossorigin="anonymous" src="https://connect.facebook.net/es_LA/sdk.js#xfbml=1&version=v17.0&appId=TU_APP_ID_FACEBOOK&autoLogAppEvents=1"></script>

</head>
<body>
<header class="header">
    <a href="sidebar.html"><img src="img/yogui.png" alt="Logo Izquierdo" class="logo-left"></a>
...
<div class="main-content">
  <div class="login-container">
    ...
    <p>Si tienes preguntas , no dudes en contactarnos, estaremos encantados de ayudarte  .</p>
    <p>Para más información haz clic <a href="#">aquí</a>.</p>
...
<div id="mySidenav" class="sidenav">
    <div>
      ...
      <a href="sesio.php">inicio de sesión</a>
      <a href="#">Empresas</a>

...
<body>
<header class="header">
    <img src="img/qqq.png" alt="Logo Izquierdo" class="logo-left">
...
<section>    
   <center>  <h2>Contactános</h2>  </center>
    <p>Si eres alguna empresa, fundación o alguien interesado no dudes en contactarnos para darte de alta con el procedimiento e información correspondiente.</p>
    <form action="#" method="POST">
    <label for="name">Nombre:</label>
    <input type="text" id="name" name="name" required placeholder="nombre de la empresa/usuario interesado" >
  
     <label for="email">Correo electrónico:</label>
 <input type="email" id="email" name="email" required placeholder="email de contacto">


      <label for="name">motivos/razones:</label>
      <textarea name="" id="" rows=5 required placeholder="escribe aquí"></textarea>
...
<div id="mySidenav" class="sidenav">
    ...
    <!-- FOOTER CON VIDEO -->
    <div class="foter">
      <video id="logoVideo" class="logo-video" src="img/ultimate.mp4" muted width="300px" height="200px"></video>
    </div>

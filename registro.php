...
<body>
<header class="header">
    <img src="img/yogui.png" alt="Logo Izquierdo" class="logo-left">
...
<div class="main-content">
  <div class="login-container">
    ...
    <p>Si tienes preguntas o quieres registrarte, no dudes en ponerte en contacto con nosotros. Estaremos encantados de ayudarte, para más información haz clic <a href="#">aquí</a>.</p>
...
<div id="mySidenav" class="sidenav">
    <div>
      <div class="user-view">
        <a href="#user"><img class="circle" src="https://www.flaticon.es/iconos-gratis/imagen-de-perfil" height="80px" width="80px"></a>
